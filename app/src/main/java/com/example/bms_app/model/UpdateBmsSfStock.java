...
public class UpdateBmsSfStock {
    ...
    public UpdateBmsSfStock(int bmsStockDeatilId, int sfId, int bmsStockId, float prodIssueQty, float prodRejectedQty, float prodReturnQty, float mixingIssueQty, float mixingRejectedQty, float bmsClosingStock) {
