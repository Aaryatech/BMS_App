...
public class UpdateBmsStock {
    ...
    public UpdateBmsStock(int bmsStockDeatilId, int rmId, int bmsStockId, float prodIssueQty, float prodRejectedQty, float prodReturnQty, float mixingIssueQty, float mixingRejectedQty, float mixingReturnQty, float storeIssueQty, float storeRejectedQty, float bmsClosingStock, float mixingReceiveRejectedQty, float mixingRecQty) {
