...
public class BillOfMaterialHeader {
    ...
    public BillOfMaterialHeader(int reqId, int productionId, String productionDate, int isProduction, int fromDeptId, String fromDeptName, int toDeptId, String toDeptName, int senderUserid, String reqDate, int approvedUserId, String approvedDate, int status, int exBool1, int delStatus, int exInt1, int exInt2, String exVarchar1, String exVarchar2, int isPlan, int isManual, int rejUserId, String rejDate, int rejApproveUserId, String rejApproveDate, List<BillOfMaterialDetailed> billOfMaterialDetailed) {
        this.reqId = reqId;
