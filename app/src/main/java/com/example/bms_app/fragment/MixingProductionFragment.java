...
import com.example.bms_app.adapter.ProductionMixingAdapter;
 ...
 */
public class MixingProductionFragment extends Fragment implements View.OnClickListener {
    private RecyclerView recyclerView;
    private FloatingActionButton fab;
    List<ProdPlanHeader> productionList = new ArrayList<>();
    ProductionMixingAdapter adapter;
                ...
                public void onResponse(Call<ProductionDetail> call, Response<ProductionDetail> response) {
                    try {
                        if (response.body() != null) {
                            ...
                            Log.e("PRODUCTION MIXING  : ", " ------------------------PRODUCTION MIXING LIST--------------------- " + response.body());
                            ...
                            adapter = new ProductionMixingAdapter(productionList, getContext());
