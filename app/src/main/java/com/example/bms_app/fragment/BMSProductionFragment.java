...
import com.example.bms_app.adapter.BMSProductionListAdapter;
 ...
 */
public class BMSProductionFragment extends Fragment implements View.OnClickListener{
    private RecyclerView recyclerView;
    private FloatingActionButton fab;
    List<MixingHeaderList> mixingList = new ArrayList<>();
    List<MixingHeaderList> mixList = new ArrayList<>();
    BMSProductionListAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_bmsproduction, container, false);
        getActivity().setTitle("BMS Production List");
        recyclerView = view.findViewById(R.id.recyclerView);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        //  sdf.format(System.currentTimeMillis())
        getMixingList(sdf.format(System.currentTimeMillis()),sdf.format(System.currentTimeMillis()));
        return view;
    }


    private void getMixingList(String fromDate, String toDate) {
        ...
        if (Constants.isOnline(getContext())) {
            ...
            Call<MixingHeader> listCall = Constants.myInterface.getMixingHeaderList(fromDate,toDate);
            listCall.enqueue(new Callback<MixingHeader>() {
                @Override
                public void onResponse(Call<MixingHeader> call, Response<MixingHeader> response) {
                    try {
                        if (response.body() != null) {
                            ...
                            adapter = new BMSProductionListAdapter(mixingList, getContext());
                ...
                @Override
                public void onFailure(Call<MixingHeader> call, Throwable t) {
                    commonDialog.dismiss();
