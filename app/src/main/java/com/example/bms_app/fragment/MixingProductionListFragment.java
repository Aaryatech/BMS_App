...
import com.example.bms_app.adapter.MixingProductionListAdapter;
 ...
 */
public class MixingProductionListFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_mixing_production_list, container, false);
        getActivity().setTitle("Mixing Production List");
                ...
                public void onResponse(Call<MixingHeader> call, Response<MixingHeader> response) {
                    try {
                        if (response.body() != null) {
                            ...
                            adapter = new MixingProductionListAdapter(mixingList, getContext());
