...
public class RequestForStoreAdapter extends RecyclerView.Adapter<RequestForStoreAdapter.MyViewHolder> {

    private List<ProdPlanHeader> reqStoreList;
    ...
    @NonNull
    @Override
    public RequestForStoreAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RequestForStoreAdapter.MyViewHolder myViewHolder, int i) {
        ...
        {
            myViewHolder.tvStatus.setText("Add From roduction");
...
//                    String dateFormate =sdf.format(System.currentTimeMillis());
                    ...
                    Date date = null;
                    try {
                        date = formatter.parse(currentDate);//catch exception
